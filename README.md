...
- **账户规模**：~$7,137（Robinhood,2026-05-28 订单历史轧差估算;现金 ~$2,597 + 持仓 ~$4,540）
- **历史净入金**：~$6,675（含 5/13 一笔 +$5,000;开户至今总盈利仅 ~+$460 / +7%）
- **风险偏好**：成长偏激进；账户层面回撤承受 ~-15-20%;单股 -25% 可接受;不能所有票一起 -25%
- **当前 YTD**：⚠️ **待核实**（旧记录称 +49%,但与完整交易历史对不上——真实账户回报约 +7%;+49% 可能指某早期阶段或单笔如 MU +39%,详见 `analysis/portfolio/2026-05-29_*.md` 第〇节）
- **当前持仓**（2026-05-28,估算）：CIEN 2 股 / MU 1 股 / QCOM 3 股 / SPY ~1.375 股 / DTCR ~16.74 股 / BB 30 股 + DJT 6/18 call + BB 6/12 call;NVDA/MRNA/BE/SATS/TSLA/BTC/GLD 等已全平
...
- 2026-05-29：完整订单历史(4/6–5/28)轧差 → 持仓 v4 + 现金/NAV 全核算;发现账户口径问题(真实回报 ~+7% vs 旧称 +49%);两周高频翻仓纪律复盘
