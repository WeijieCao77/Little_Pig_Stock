...
| 日期 | 文件 | 主题 | 框架版本 |
|---|---|---|---|
| 2026-05-14 | `2026-05-14_4_sectors_deep_research.md` + `.pdf` | 核能 / 机器人 / 无人机 / 军工四板块深度研究 PDF(14 页,每板块走 前提核查 + 行业结构 + 驱动 + 风险 + 美股名单 + 估值 sanity + 实操含义 + 综合结论 + 不要立即建仓清单)| Layer 1 / 行业地图 |
