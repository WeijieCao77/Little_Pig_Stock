...
ACCOUNT = {
    "as_of": "2026-06-02",
    "nav": 7724.82,          # ✅ Robinhood 账户页确认(今日 +3.44%)
    "cash": 1191.27,         # ✅ buying power 确认(我轧差估 1191.65,几乎完全命中)
    "net_deposits": 6675.08, # 历史净入金(含 bonus)
}

# ── 2. 当前持仓最新价(用于未实现盈亏)──────────────────────────────
PRICES = {     # 2026-06-02 16:47 Robinhood last price(账户页确认)
    "MU": 1066.30, "SPY": 759.90, "DTCR": 32.31, "ASTS": 117.40,
    "BB": 10.82, "ADBE": 262.98, "MRVL": 297.00,
}
